...
ActiveRecord::Schema.define(version: 2020_12_10_130745) do
  ...
  create_table "orders", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["users_items_id"], name: "index_orders_on_users_items_id"
  end
  ...
  create_table "users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.string "family_name_jp", default: "", null: false
    t.string "first_name_jp", default: "", null: false
  ...
  add_foreign_key "orders", "users_items", column: "users_items_id"
